...
pub fn main() !void {
    ...
    var out_comp = try flate.deflate.compressor(
        .raw,
    ...
    // TODO: This should use the target endianness, not the host endianness!
    ...
    try writer.writeInt(u16, @intCast(stage3.items.len), endian);
